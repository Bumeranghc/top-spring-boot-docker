...
In Windows with WSL2 uou can use Jenkins container for building:

====
[source,bash]
----
docker run -u root --name jenkins_lts -p 8080:8080 -p 50000:50000 -v <your_local_jenkins_settings_directory>:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock -v /mnt/wsl/docker-desktop/cli-tools/usr/bin/docker:/usr/bin/docker -v /mnt/wsl/docker-desktop/cli-tools/usr/bin/com.docker.cli:/usr/bin/com.docker.cli jenkins/jenkins:lts-jdk8
----
====
